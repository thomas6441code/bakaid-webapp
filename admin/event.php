        ...
        <div class="min-w-full px-3 text-lg md:px-5">
            <div class="text-cyan-950 mb-20">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button onclick="window.location.href='create_event.php'" class="bg-blue-500 text-white px-4 py-2 rounded">Create Events</button>
                </div>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr class='border-t'>
                                            ...
                                            <td class='px-4 py-2'>
                                                <img src='../public/images/" . $row['mainImage'] . "' alt='Main' class='h-40 min-w-60 object-cover'>
                                            </td>
                                            <td class='px-2 py-2'>
                                                ...
                                                <button onclick=\"window.location.href='edit_event.php?id=" . $row['id'] . "'\" class='bg-yellow-500 text-white px-4 py-1 my-1 mx-1 rounded'>Edit</button>
