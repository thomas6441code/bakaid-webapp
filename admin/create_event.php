...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("INSERT INTO event (title, description, moreDescription, date, location, eventType, mainImage, image1, image2, image3, image4, updatedAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())");
    $stmt->bind_param("sssssssssss", $title, $description, $moreDescription, $date, $location, $eventType, $uploadedMainImage, $uploadedImage1, $uploadedImage2, $uploadedImage3, $uploadedImage4);
