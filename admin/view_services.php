...
?>
    ...
    <div class="mt-16 md:ml-44 w-fit py-4 pb-10">
        ...
        <div id="projectDetails" class="mb-8 bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <p class="mb-1"><strong>FundSource:</strong> <span id="projectfundSource"><?php echo htmlspecialchars($service['fundSource']); ?></span></p>
            ...
            <div id="projectMoreDescription" class="mt-2"><?php echo htmlspecialchars($service['beneficalGroup']); ?></div>
        </div>
