        ...
        <div class="min-w-full px-3 text-lg md:px-5">
            <div class="text-cyan-950 mb-20">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button onclick="createProject()" class="bg-blue-500 text-white px-4 py-2 rounded">Create Services</button>
                </div>
                    ...
                    <table class="min-w-full rounded-lg shadow-md">
                        <thead>
                            <tr class="bg-gray-300 text-left">
                                ...
                                <th class="px-4 pr-28 py-2">Description</th>
                                <th class="px-4 py-2">Beneficial Group</th>
                            ...
                            <?php 
                             ...
                             while($project = $result->fetch_assoc()): ?>
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2"><?= htmlspecialchars($project['beneficalGroup']) ?></td>
                                    ...
                                    <td class="px-2 py-2">
                                        ...
                                        <button onclick="editProject(<?= $project['id'] ?>)" class="bg-yellow-500 text-white px-4 py-1 my-1 mx-1 rounded">Edit</button>
