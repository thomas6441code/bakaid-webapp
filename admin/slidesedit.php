        ...
        <div class="min-w-full px-3 text-lg md:px-5">
            <div class="text-cyan-950 mb-20">
                ...
                <form id="projectForm" class="space-y-6" method="POST" enctype="multipart/form-data">
                    ...
                    <?php if ($slide['image']): ?>
                        <div class="mb-6">
                            <label class="block text-lg font-semibold mb-2">Current Image</label>
                            <img src="../public/images/<?php echo $slide['image']; ?>" alt="Current Image" class="w-full h-auto border rounded-md" />
                        </div>
                    <?php endif; ?>
